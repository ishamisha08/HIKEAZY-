...
const Dashboard = () => {
  const { aToken, getDashData, dashData, cancelBooking } = useContext(AdminContext);
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-10 max-w-[95%] mx-auto">
          ...
          <div className="bg-gradient-to-br from-[#F5F5DC] to-[#E8E6D1] text-gray-800 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
            <div className="flex items-center gap-4">
              <img className="w-16 h-16 rounded-full" src={assets.trails} alt="Trails" />
              <div>
                <p className="text-5xl font-bold">{dashData.trails}</p>
                <p className="text-gray-600 text-lg font-medium">Trails</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-[#F5F5DC] to-[#E8E6D1] text-gray-800 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-5xl font-bold">{dashData.bookings}</p>
          ...
          <div className="bg-gradient-to-br from-[#F5F5DC] to-[#E8E6D1] text-gray-800 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-5xl font-bold">{dashData.hikers}</p>
          ...
          >
            {dashData.latestBookings.map((item, index) => (
              ...
              >
                {/* Trail Image */}
                <img
                  src={item.trailData.image || assets.default_image}
                  alt={item.trailData.name || 'Trail'}
